...
const NuevaCuenta = () => {
    ...
    const formik = useFormik({
        initialValues: {
            ...
            validationSchema: Yup.object({
                ...
                password: Yup.string().required('La contraseña no puede ir vacia').min(8, 'La contraseña debe de tener un minimo de 8 caracteres')
    ...
    return (
        <>
            <Layout>
                <h1 className="text-center text-white text-2xl" >Nuevo registro de usuario</h1>
