                  ...
                  <td className="border px-4 py-2">
                    <Link href={"/prestamos/" + libro.id}>
                      <a
                        className={` ${
                          libro.isOnLoan
                            ? "bg-yellow-700 disabled"
                            : "bg-green-700 hover:bg-green-800"
                        }  h-8 px-4 m-2 text-sm text-indigo-100 transition-colors duration-150  
                    ...
                    <button
                      className="h-8 px-4 m-2 text-sm text-indigo-100 transition-colors duration-150 bg-yellow-500 
                                      rounded-lg focus:shadow-outline hover:bg-yellow-800"
                    >
                      Editar
                    </button>
                    <button
