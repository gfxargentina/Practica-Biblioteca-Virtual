        ...
        <div className="flex justify-center mt-5">
          <div className="w-full max-w-xl">
            ...
            >
              ...
              <input
                type="submit"
                className="bg-gray-800 w-full mt-5 p-2 text-white uppercase hover:bg-gray-700 cursor-pointer"
                value="Iniciar Sesion"
              />

              <Link href="/nuevacuenta">
                <button className="bg-gray-800 w-full mt-5 p-2 text-white uppercase hover:bg-gray-700">
                  NUEVA CUENTA
                </button>
              </Link>
            </form>
